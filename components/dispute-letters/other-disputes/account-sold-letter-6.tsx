...
const AccountSoldLetter6 = (info: Props) => {
    const {
        clientName,
        clientAddress,
        clientCity,
    ...
    return (
        <div className="max-w-2xl mx-auto p-8 bg-white shadow-md rounded-md border border-gray-200">
            <div className="space-y-3 text-sm">
                ...
                {/* Subject */}
                <p>Subject: Urgent Request for Reevaluation Based on Additional Information</p>
                ...
                <ol className="list-decimal pl-4">
                    <li>
                        The presumption of validity lies with my dispute unless you possess concrete evidence to the contrary. Should you lack such evidence and yet fail to investigate, this constitutes non-compliance with the FCRA.
                    </li>
                    <li>
                        The provision of new information from my end mandates a re-investigation of the disputed account. A failure to do so further indicates non-compliance on your part.
                    </li>
                </ol>
...
export default AccountSoldLetter6;
