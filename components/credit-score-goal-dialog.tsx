...
const CreditScoreGoalDialog = ({ open, onOpenChange }: CreditScoreGoalDialogProps) => {
  ...
  const handleSubmit = () => {
    // Here you would typically save the goal settings
    console.log({
      purpose,
      currentScore,
      motivation,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] overflow-hidden">
            ...
            {[1, 2, 3, 4, 5].map((number) => (
              <div
                ...
                className={cn(
                  ...
                  step >= number ? "bg-brand-yellow text-brand-navy" : "bg-gray-200 text-gray-500"
                )}
              >
                {number}
              </div>
          ...
          <div className="space-y-6">
            {step === 1 && (
              <div className="space-y-4 animate-in slide-in-from-right">
                <div className="flex items-center space-x-3 text-brand-navy">
                  ...
                  <Label className="text-lg font-medium">What brings you here?</Label>
                </div>
            ...
            {step === 2 && (
              <div className="space-y-4 animate-in slide-in-from-right">
                <div className="flex items-center space-x-3 text-brand-navy">
                  ...
                  <Label className="text-lg font-medium">What's your current credit score?</Label>
                </div>
            ...
            {step === 3 && (
              <div className="space-y-4 animate-in slide-in-from-right">
                <div className="flex items-center space-x-3 text-brand-navy">
                  ...
                  <Label className="text-lg font-medium">What's your motivation?</Label>
                </div>
            ...
            {step === 4 && (
              <div className="space-y-4 animate-in slide-in-from-right">
                <div className="flex items-center space-x-3 text-brand-navy">
                  ...
                  <Label className="text-lg font-medium">How soon do you want to reach your goal?</Label>
                </div>
            ...
            {step === 5 && (
              <div className="space-y-6 animate-in slide-in-from-right">
                <div className="flex items-center space-x-3 text-brand-navy">
                  <Target className="h-5 w-5" />
                  <Label className="text-lg font-medium">What's your target credit score?</Label>
                </div>
                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="mb-8">
                    ...
                    <div className="flex justify-between mt-4">
                      <span className="text-sm text-gray-500">Poor<br/>300</span>
                      <span className="text-sm text-gray-500">Fair<br/>580</span>
                      <span className="text-sm text-gray-500">Good<br/>670</span>
                      <span className="text-sm text-gray-500">Very Good<br/>740</span>
                      <span className="text-sm text-gray-500">Exceptional<br/>850</span>
                    </div>
                  </div>
                  <div className="text-center">
                    <div className={cn("text-4xl font-bold mb-2", getScoreColor(targetScore[0]))}>
                      {targetScore[0]}
                    </div>
                    <div className="text-gray-600">{getScoreLabel(targetScore[0])}</div>
                  </div>
                </div>
              </div>
            )}
        ...
        <div className="flex justify-end pt-6 border-t">
          ...
          >
            {step === 5 ? 'Save Goal' : 'Continue'} <ChevronRight className="ml-2 h-4 w-4" />
          </Button>
        </div>
      </DialogContent>
    </Dialog>
